...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        sa.Column("src_entity_id", sa.String(), sa.ForeignKey("entities.entity_id"), nullable=False),
        sa.Column("dst_entity_id", sa.String(), sa.ForeignKey("entities.entity_id"), nullable=False),
